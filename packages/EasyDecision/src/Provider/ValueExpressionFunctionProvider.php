...
use EonX\EasyDecision\Exception\InvalidArgumentException;
...
final class ValueExpressionFunctionProvider
{
    ...
    private function if(): ExpressionFunctionInterface
    {
        return new ExpressionFunction(
            'if',
            function ($arguments, $condition): IfConditionForValueHelper {
                $this->validateArguments($arguments);

                return new IfConditionForValueHelper((bool)$condition, $arguments['value']);
            },
