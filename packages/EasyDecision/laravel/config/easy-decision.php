...
return [
    ...
    |
    | 'my-decision' => [
    |     'type' => \EonX\EasyDecision\Decision\UnanimousDecision::class,
    |     'providers' => [
    ...
    */
    ...
    | It can be one of:
    |       \EonX\EasyDecision\Rule\RuleInterface
    |       \EonX\EasyDecision\Rule\RestrictedRuleInterface
    |
    | Example:
    |
    ...
    */
    ...
    | Example:
    |
    | 'my-decision' => \EonX\EasyDecision\Decision\UnanimousDecision::class
    |
    */
    'type_mapping' => [],
