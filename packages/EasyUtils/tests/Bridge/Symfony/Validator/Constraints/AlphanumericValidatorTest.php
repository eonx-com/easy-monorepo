...
final class AlphanumericValidatorTest extends AbstractTestCase
{
    /**
    ...
    public function testValidateThrowsUnexpectedTypeException(): void
    {
        ...
        $this->expectExceptionMessage(
            'Expected argument of type "EonX\EasyUtils\Bridge\Symfony\Validator\Constraints\Alphanumeric"'
        );
