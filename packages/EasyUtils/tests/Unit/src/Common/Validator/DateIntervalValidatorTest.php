...
use EonX\EasyUtils\Common\Validator\DateIntervalValidator;
...
final class DateIntervalValidatorTest extends AbstractUnitTestCase
{
    /**
    ...
    public function testValidateThrowsUnexpectedTypeException(): void
    {
        ...
        $this->expectExceptionMessage(
            'Expected argument of type "EonX\EasyUtils\Common\Constraint\DateInterval"'
        );
