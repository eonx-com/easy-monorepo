...
use EonX\EasyUtils\Common\Validator\AlphanumericHyphenValidator;
...
final class AlphanumericHyphenValidatorTest extends AbstractUnitTestCase
{
    /**
    ...
    public function testValidateThrowsUnexpectedTypeException(): void
    {
        ...
        $this->expectExceptionMessage(
            'Expected argument of type "EonX\EasyUtils\Common\Constraint\AlphanumericHyphen"'
        );
