...
use EonX\EasyUtils\Common\Validator\AbnValidator;
...
final class AbnValidatorTest extends AbstractUnitTestCase
{
    /**
    ...
    public function testValidateThrowsUnexpectedTypeException(): void
    {
        ...
        $this->expectExceptionMessage(
            'Expected argument of type "EonX\EasyUtils\Common\Constraint\Abn"'
        );
