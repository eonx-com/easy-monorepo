...
<<<<<<<< HEAD:packages/EasyErrorHandler/tests/Bridge/EasyBugsnag/Reporters/BugsnagReporterTest.php
...
>>>>>>>> refs/heads/6.x:packages/EasyErrorHandler/tests/Unit/src/Bugsnag/Reporter/BugsnagErrorReporterTest.php
use Exception;
use Monolog\Logger;
