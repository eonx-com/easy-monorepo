...
final class DoctrineSqlLoggerConfiguratorCompilerPass implements CompilerPassInterface
{
    ...
    {
        $enabled = $this->getParam($container, ConfigParam::DoctrineDbalEnabled->value, false);
        ...
        $container->setDefinition(
            ...
            (new Definition(DoctrineSqlLogger::class, [new Reference(Client::class)]))->setAbstract(true)
        );
