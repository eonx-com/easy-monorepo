...
abstract class AbstractJwtTokenTestCase extends AbstractUnitTestCase
{
    ...
    {
        return \openssl_pkey_get_private(\sprintf('file://%s', __DIR__ . '/../../../../Fixture/keys/jwt-private.pem'));
    }

    protected function getOpenSslPublicKey(): false|OpenSSLAsymmetricKey
    {
        return \openssl_pkey_get_public(\sprintf('file://%s', __DIR__ . '/../../../../Fixture/keys/jwt-public.pem'));
    }
