...
final class StrictDeclarationFormatSniffTest extends AbstractCheckerTestCase
{
    ...
    {
        yield [new SmartFileInfo(__DIR__ . '/../../fixtures/Sniffs/Classes/StrictDeclarationFormatSniffTest_ExtraLine.php.inc'), 1];
        yield [new SmartFileInfo(__DIR__ . '/../../fixtures/Sniffs/Classes/StrictDeclarationFormatSniffTest_SameLine.php.inc'), 2];
    }
