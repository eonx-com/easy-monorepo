...
namespace EonX\EasyDoctrine\AwsRds\Factory;

use Doctrine\Bundle\DoctrineBundle\ConnectionFactory;
use Doctrine\Common\EventManager;
use Doctrine\DBAL\Configuration;
use Doctrine\DBAL\Connection;
use EonX\EasyDoctrine\AwsRds\Driver\DbalAwsRdsDriver;
use EonX\EasyDoctrine\AwsRds\Resolver\AwsRdsConnectionParamsResolver;

final class AwsRdsAuthTokenConnectionFactory extends ConnectionFactory
{
    ...
    public function createConnection(
        ...
        return new $connectionClass(
            ...
            new DbalAwsRdsDriver($connection->getDriver(), $this->connectionParamsResolver),
