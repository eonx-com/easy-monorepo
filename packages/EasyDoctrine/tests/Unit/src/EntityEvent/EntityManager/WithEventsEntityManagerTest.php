...
namespace EonX\EasyDoctrine\Tests\Unit\EntityEvent\EntityManager;
...
#[CoversClass(WithEventsEntityManager::class)]
final class WithEventsEntityManagerTest extends AbstractUnitTestCase
{
    /**
