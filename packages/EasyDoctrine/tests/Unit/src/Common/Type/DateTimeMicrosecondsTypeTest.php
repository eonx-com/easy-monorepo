...
use EonX\EasyDoctrine\Common\Type\DateTimeMicrosecondsType;
use EonX\EasyDoctrine\Tests\Unit\AbstractUnitTestCase;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;

#[CoversClass(DateTimeMicrosecondsType::class)]
final class DateTimeMicrosecondsTypeTest extends AbstractUnitTestCase
{
    ...
    {
        /** @var \EonX\EasyDoctrine\Common\Type\DateTimeMicrosecondsType $type */
