            ...
            ->arrayNode('aws_rds')
                ...
                ->children()
                    ->arrayNode('iam')
                        ->canBeEnabled()
                        ->children()
                            ->stringNode('assume_role_arn')->defaultNull()->end()
                            ->integerNode('assume_role_duration_seconds')->defaultValue(900)->end()
                            ->stringNode('assume_role_region')->defaultNull()->end()
                            ->stringNode('assume_role_session_name')->defaultNull()->end()
