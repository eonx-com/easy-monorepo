...
use EonX\EasyRepository\Tests\Stub\Repository\RepositoryAStub;
use EonX\EasyRepository\Tests\Stub\Repository\RepositoryBStub;
use LogicException;
    ...
    public function testRegisterRepositoriesSuccessfully(): void
    {
        ...
        \config()
            ->set('easy-repository.repositories', [
                'interface-1' => RepositoryAStub::class,
                'interface-2' => RepositoryBStub::class,
            ]);
        ...
        $this->assertInstanceInApp(RepositoryAStub::class, 'interface-1');
        $this->assertInstanceInApp(RepositoryBStub::class, 'interface-2');
    }
}
