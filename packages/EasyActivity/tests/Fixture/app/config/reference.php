 ...
 * @psalm-type EasyActivityConfig = array{
 *     easy_doctrine?: array{
 *         subscriber?: bool|array{
 *             enabled?: bool, // Default: true
 *         },
 *     },
 *     table_name?: string, // The name for table with logs. Defaults to "easy_activity_logs". // Default: "easy_activity_logs"
 *     disallowed_properties?: list<string>,
 *     fully_serializable_properties?: list<string>,
 *     subjects?: array<string, array{ // Default: []
 *         type?: string, // Subject type. Defaults to short class name of subject.
 *         allowed_actions?: list<mixed>,
 *         disallowed_properties?: list<string>,
 *         allowed_properties?: list<mixed>,
 *         fully_serializable_properties?: list<string>,
 *         nested_object_allowed_properties?: list<mixed>,
 *     }>,
 * }
 ...
 *     "when@global_and_subject_disallowed_properties"?: array<string, RouteConfig|ImportConfig|AliasConfig>,
